...
if ((Lado1 < Lado2 + Lado3) && (Lado2 < Lado1 + Lado3) && (Lado3 < Lado1 + Lado2) && (Lado1 == Lado2) && (Lado2 == Lado3)) {
    console.log('Pode formar um triangulo')
    console.log('Triangulo Equilatero')
}

else if ((Lado1 < Lado2 + Lado3) && (Lado2 < Lado1 + Lado3) && (Lado3 < Lado1 + Lado2) && ((Lado1 != Lado2) && (Lado2 != Lado3) && (Lado1 != Lado3))) {
